...
class MenuAdapter(
    private val menuItems: MutableList<Menu.MenuItem>,
    ...
    interface OnMenuItemClickListener {
        ...
        fun onRemoveItemClick(position: Int, menuItem: Menu.MenuItem)
    }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder is HeaderViewHolder) {
            ...
            holder.itemView.setOnLongClickListener {
                onMenuItemClickListener.onRemoveItemClick(position, menuItem)
                true
            }
        }
    }
